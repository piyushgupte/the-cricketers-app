...
describe('Player table container', () => {
    ...
    jest
        ...
        .mockImplementation(jest.fn().mockReturnValue({ data: { ...players }, isLoading: false, isSuccess: true }));
    ...
    it('should render player table on success', () => {
        ...
        render(
            <Provider store={store}>
                <PlayersTable
                    data={players as TPlayer[]}
                    refetchPlayersInfo={() => { refetch() }}
                    isLoading={isLoading}
                    dispatch={dispatch}
                    error={error}
                    state={state as cricketerSliceType}
